...
strikeButton.onclick=()=>{
    ...
    {
        team2BallsFaced++;
        document.querySelector(`#team2-superover div:nthchild(${team2BallsFaced}`).textContent=randomElement;
        //${varName}
        if(randomElement==="wicket")
        {
            team2Wickets++;
        }
        else{
    ...
    {
        team1BallsFaced++;
        document.querySelector(`#team1-superover div:nthchild(${team1BallsFaced}`).textContent=randomElement;
        if(randomElement==="w")
        {
            team1Wickets++;
        }
